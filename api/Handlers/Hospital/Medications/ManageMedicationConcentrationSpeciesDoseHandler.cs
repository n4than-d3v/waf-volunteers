    ...
    public async Task<IResult> Handle(ManageMedicationConcentrationSpeciesDose request, CancellationToken cancellationToken)
    {
        ...
        if (request.Id == null)
        {
            ...
            var medicationConcentrationSpeciesDose = new MedicationConcentrationSpeciesDose
            {
                ...
                DoseMgKg = request.DoseMgKg,
                DoseMlKg = request.DoseMlKg,
        ...
        else
        {
            ...
            else
            {
                ...
                medicationConcentrationSpeciesDose.DoseMgKg = request.DoseMgKg;
                medicationConcentrationSpeciesDose.DoseMlKg = request.DoseMlKg;
