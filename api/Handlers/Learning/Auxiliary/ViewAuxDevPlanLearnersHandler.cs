...
public class ViewAuxDevPlanLearnersHandler : IRequestHandler<ViewAuxDevPlanLearners, IResult>
{
    ...
    public ViewAuxDevPlanLearnersHandler(
    ...
    public async Task<IResult> Handle(
        ViewAuxDevPlanLearners request,
    ...
    )
    {
        ...
        var learners = await _repository.GetAll<Account>(
        ...
        var plans = learners
            ...
            .Select(learner =>
            {
                ...
                return new Learner
                {
                    ...
                    Tasks = tasks
                        .Select(task => new Learner.LearnerTask
                        {
                            Id = task.Id,
                            Name = task.Name,
                            Witnesses = task
                                .Witnesses.Where(x => x.PerformedBy.Id == learner.Id)
                                .Select(witness =>
                                {
